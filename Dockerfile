...
# Install packages
RUN apk add --no-cache bash less htop mc git whois bind-tools curl wget zip unzip openssl openssh jq inetutils-telnet procps-ng coreutils mysql-client mariadb-client postgresql15-client kubectx nmap shellcheck \
